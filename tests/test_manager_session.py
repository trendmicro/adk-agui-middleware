...
class TestSessionManager(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(self.session_manager.session_service, self.mock_session_service)
    ...
    async def test_check_and_create_session_existing(self):
        ...
        result = await self.session_manager.check_and_create_session(self.session_parameter)
