...
class TestEndpointRegistration(unittest.TestCase):
    ...
    def test_register_agui_endpoint_custom_path(self):
        ...
        register_agui_endpoint(self.mock_app, self.mock_sse_service, custom_path)
        
        # Verify the endpoint was registered with custom path
        self.mock_app.post.assert_called_once_with(custom_path)

    async def test_agui_endpoint_success(self):
    ...
    async def test_agui_endpoint_with_exception(self):
    ...
    async def test_endpoint_parameters_and_return_type(self):
    ...
    def test_multiple_endpoint_registrations(self):
        ...
        for path in paths:
            register_agui_endpoint(self.mock_app, self.mock_sse_service, path)
