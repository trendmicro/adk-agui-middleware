...
class MockSessionParameter:
    def __init__(
        self, app_name="test_app", user_id="test_user", session_id="test_session"
    ):
...
class TestSessionHandler(unittest.TestCase):
    ...
    def test_session_parameter_modification(self):
        ...
        new_param = MockSessionParameter(
            app_name="new_app", user_id="new_user", session_id="new_session"
        )
    ...
    def test_async_method_call_order(self):
        ...
        async def run_test():
            # Setup mocks
            self.mock_session_manager.get_session = AsyncMock(
