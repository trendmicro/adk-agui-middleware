...
from adk_agui_middleware.loggers.record_log import record_log, record_error_log
...
class TestSimpleCoverage(BaseTestCase):
    ...
    def test_record_log_basic(self):
        ...
        with patch('adk_agui_middleware.loggers.record_log.LogMessage') as mock_log_message:
            mock_instance = Mock()
            mock_instance.model_dump.return_value = {"msg": "Simple test log", "func_name": "test"}
    ...
    def test_record_error_log_with_exception(self):
        ...
        with patch('adk_agui_middleware.loggers.record_log.LogMessage') as mock_log_message:
            mock_instance = Mock()
            mock_instance.model_dump.return_value = {"msg": "Error occurred", "func_name": "test"}
            mock_log_message.return_value = mock_instance
    ...
    def test_json_encoder_edge_cases(self):
        ...
        valid_bytes = "Hello 世界".encode('utf-8')
