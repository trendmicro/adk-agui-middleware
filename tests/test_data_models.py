...
from adk_agui_middleware.data_model.context import (
    ContextConfig, RunnerConfig, default_session_id
)
...
class TestDataModels(BaseTestCase):
    ...
    def test_session_parameter_creation(self, app_name: str, user_id: str, session_id: str):
    ...
    def test_session_parameter_equality_comparison(self):
        ...
        param1 = SessionParameter(app_name="test_app", user_id="test_user", session_id="test_session")
        param2 = SessionParameter(app_name="test_app", user_id="test_user", session_id="test_session")
        param3 = SessionParameter(app_name="different", user_id="test_user", session_id="test_session")
    ...
    async def test_context_config_with_callables(self):
        ...
        config = ContextConfig(
            ...
            extract_initial_state=custom_initial_state
        )
    ...
    def test_runner_config_custom_values(self, streaming_mode: StreamingMode, use_in_memory: bool):
    ...
    def test_runner_config_existing_services(self):
        ...
        config = RunnerConfig(
            ...
            artifact_service=existing_service
        )
