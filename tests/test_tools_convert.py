...
class TestConvertAGUIMessagesToADK(unittest.TestCase):
    ...
    def test_convert_with_exception(self, mock_log):
        ...
        with patch('adk_agui_middleware.tools.convert.convert_agui_to_adk_event', 
...
class TestHandleToolMessage(unittest.TestCase):
    ...
    def test_tool_message_conversion(self):
        ...
        self.assertEqual(result.parts[0].function_response.response["result"], "Tool result")
...
class TestConvertAGUIToADKEvent(unittest.TestCase):
    ...
    def test_tool_message_conversion(self):
        ...
        tool_msg = ToolMessage(id="1", role="tool", content="Result", tool_call_id="call1")
...
class TestConvertADKEventToAGUIMessage(unittest.TestCase):
    ...
    def test_convert_with_exception(self, mock_log):
        ...
        type(mock_event.content).parts = PropertyMock(side_effect=Exception("Test error"))
