...
class TestSessionManagerCoverage(BaseTestCase):
    ...
    async def test_update_session_state_success(self):
        ...
        result = await self.manager.update_session_state(self.session_param, state_updates)
    ...
    async def test_get_session_state_exception(self):
        ...
        self.mock_service.get_session = AsyncMock(side_effect=Exception("Database error"))
    ...
    async def test_get_state_value_exception(self):
        ...
        self.mock_service.get_session = AsyncMock(side_effect=RuntimeError("Service error"))
